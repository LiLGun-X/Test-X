...
echo ""
echo "       ___________              __            ____  ___"|lolcat
echo "       \__    ___/___   _______/  |_          \   \/  /"|lolcat
echo "         |    |_/ __ \ /  ___/\   __\  ______  \     / "|lolcat
echo "         |    |\  ___/ \___ \  |  |   /_____/  /     \ "|lolcat
echo "         |____| \___  >____  > |__|           /___/\  \"|lolcat
echo "                                                    \ /"|lolcat                                         𝙎𝘾𝙍𝙄𝙋𝙏"
}

update(){
echo "┣ ❯❯❯ apt-get update"|lolcat
...
#if [ -e '/var/lib/vnstat/eth0' ]; then
#iptables -t nat -I POSTROUTING -s 10.8.0.0/22 -o eth0 -j MASQUERADE
#elif [ -e '/var/lib/vnstat/ens3' ]; then
#iptables -t nat -I POSTROUTING -s 10.8.0.0/22 -o ens3 -j MASQUERADE
#else
#iptables -t nat -I POSTROUTING -s 10.8.0.0/22 -o ens18 -j MASQUERADE
#fi
iptables -I FORWARD -s 10.8.0.0/22 -j ACCEPT
iptables -I FORWARD -m state --state RELATED,ESTABLISHED -j ACCEPT
iptables -t nat -A POSTROUTING -s 10.8.0.0/22 -j SNAT --to-source $SERVER_IP
